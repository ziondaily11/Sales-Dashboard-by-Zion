...
def excel_store():
    ...
    dt5= download_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vRYELTw4obFZKW7M7hMK7P3WySKBEjam5kb8PUYtmNsNcqx2-NiEGYN4EJUI3PeOoM2WUzmUxRBCdO4/pub?gid=1076665978&single=true&output=csv")
    dt6= download_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vRCLG4WKL4zOzx8xGUqRQ6UmT4rIpTwWNkZlLzwmTrV-lBPkXKP3KWpuIXinM0_Kn3h49tgcx9pxKE7/pub?gid=1251689604&single=true&output=csv")
    order_items_dt=pd.concat([dt1, dt2, dt3, dt4, dt5, dt6], ignore_index= True)
